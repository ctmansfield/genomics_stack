...
assert_type(
    i8.__divmod__(f),
    tuple[np.floating[_64Bit], np.floating[_64Bit]] | tuple[np.float64, np.float64],
)
assert_type(
    i8.__divmod__(f8),
    tuple[np.floating[_64Bit], np.floating[_64Bit]] | tuple[np.float64, np.float64],
...
assert_type(
    divmod(i8, f4), tuple[np.floating[_64Bit], np.floating[_64Bit]] | tuple[np.float32, np.float32]
)
...
assert_type(
    divmod(f, i8), tuple[np.floating[_64Bit], np.floating[_64Bit]] | tuple[np.float64, np.float64]
)
assert_type(divmod(i8, i8), tuple[np.int64, np.int64])
...
assert_type(
    f4.__divmod__(i8),
    tuple[np.floating[_64Bit], np.floating[_64Bit]] | tuple[np.float32, np.float32],
)
