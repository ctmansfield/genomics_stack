            ...
            if isinstance(caption, Paragraph):
                ...
                self.captionStyle = ParagraphStyle(
                    ...
                    alignment=(
                        ...
                        else TA_RIGHT if captionAlign == "right" else TA_CENTER
                    ),
                )
                ...
                raise ValueError(
                    "Figure caption of type %r is not a string or Paragraph" % type(caption)
                )
        ...
        if self._scaleFactor is None or self.width > availWidth or self.height > availHeight:
            ...
            if self.scaleFactor is None:
                ...
                self._scaleFactor = min(
                    availWidth / self.width, (availHeight - captionHeight) / self.figureHeight
                )
...
class ImageFigure(FlexFigure):
    ...
    def __init__(
        self, filename, caption, background=None, scaleFactor=None, hAlign="CENTER", border=None
    ):
        ...
        FlexFigure.__init__(
            self, w, h, caption, background, scaleFactor=scaleFactor, hAlign=hAlign, border=border
        )
...
if _hasPageCatcher:
    ...
    class PageCatcherFigure(PageCatcherFigureNonA4):
        ...
        def __init__(
            self, filename, pageNo, caption, width=595, height=842, background=None, caching=None
        ):
