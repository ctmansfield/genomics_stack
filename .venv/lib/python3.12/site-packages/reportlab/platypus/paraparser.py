...
def fontSizeNormalize(frag, attr, default):
    ...
    return (
        ...
        else v.normalizedValue(frag.fontSize) if isinstance(v, _PCT) else v
    )
    ...
    def getAttributes(self, attr, attrMap):
        ...
        for k, v in attr.items():
            ...
            if k in attrMap:
                ...
                self._syntax_error(
                    "invalid attribute name %s attrMap=%r" % (k, list(sorted(attrMap.keys())))
                )
        return A
...
if __name__ == "__main__":
    ...
    def check_text(text, p=_parser):
        ...
        if rv is None:
            ...
            for l in rv:
                sys.stdout.write(
                    l.fontName, l.fontSize, l.textColor, l.bold, l.rise, "|%s|" % l.text[:25]
                )
                if hasattr(l, "cbDefn"):
                    print(
                        "cbDefn",
