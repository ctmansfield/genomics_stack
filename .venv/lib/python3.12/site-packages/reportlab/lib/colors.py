...
class CMYKColor(Color):
    ...
    def __init__(
        self, cyan=0, magenta=0, yellow=0, black=0, spotName=None, density=1, knockout=None, alpha=1
    ):
        """
...
class PCMYKColor(CMYKColor):
    ...
    def __init__(
        self, cyan, magenta, yellow, black, density=100, spotName=None, knockout=None, alpha=100
    ):
        CMYKColor.__init__(
            self,
            cyan / 100.0,
...
class CMYKColorSep(CMYKColor):
    ...
    def __init__(self, cyan=0, magenta=0, yellow=0, black=0, spotName=None, density=1, alpha=1):
        CMYKColor.__init__(
            self, cyan, magenta, yellow, black, spotName, density, knockout=None, alpha=alpha
        )
...
class PCMYKColorSep(PCMYKColor, CMYKColorSep):
    ...
    def __init__(self, cyan=0, magenta=0, yellow=0, black=0, spotName=None, density=100, alpha=100):
        PCMYKColor.__init__(
            self, cyan, magenta, yellow, black, density, spotName, knockout=None, alpha=alpha
        )
...
def colorDistance(col1, col2):
    ...
    names for things."""
    return math.sqrt(
        (col1.red - col2.red) ** 2 + (col1.green - col2.green) ** 2 + (col1.blue - col2.blue) ** 2
    )
...
def _chooseEnforceColorSpace(enforceColorSpace):
    if enforceColorSpace is not None and not callable(enforceColorSpace):
        ...
        if enforceColorSpace == "CMYK":
            ...
            raise ValueError(
                "Invalid value for Canvas argument enforceColorSpace=%r" % enforceColorSpace
            )
