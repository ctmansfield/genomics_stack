...
def str2alignment(
    v,
    __map__=dict(
        centre=TA_CENTER, center=TA_CENTER, left=TA_LEFT, right=TA_RIGHT, justify=TA_JUSTIFY
    ),
):
...
def getSampleStyleSheet():
    ...
    stylesheet.add(
        ParagraphStyle(name="Italic", parent=stylesheet["BodyText"], fontName=_baseFontNameI)
    )
