...
class FontFinder:
    def __init__(
        self, dirs=[], useCache=True, validate=False, recur=False, fsEncoding=None, verbose=0
    ):
    ...
    def _getCacheFileName(self):
        ...
        fsEncoding = self._fsEncoding
        hash = md5(
            b"".join(asBytes(_, enc=fsEncoding) for _ in sorted(self._dirs)), usedforsecurity=False
        ).hexdigest()
