...
BarcodePOSTNET = _BCW(
    ...
    AttrMap(
        ...
        spaceWidth=AttrMapValue(
            isNumber, """(float or None, default 0.0275in): width of intercharacter gap."""
        ),
...
BarcodeUSPS_4State = _BCW(
    ...
    AttrMap(
        ...
        widthSize=AttrMapValue(
            isNumber, """(float, default 1): the bar width size adjustment between 0 and 1."""
        ),
        heightSize=AttrMapValue(
            isNumber, """(float, default 1): the bar height size adjustment between 0 and 1."""
        ),
        fontName=AttrMapValue(isString, desc="human readable font"),
        fontSize=AttrMapValue(isNumber, desc="human readable font size"),
