    ...
    def __init__(self, value="01234567094987654321", routing="", **kwd):
        ...
        if not routing:
            ...
            if len(value) in (20, 25, 29, 31):
                ...
                raise ValueError(
                    "value+routing length must be 20, 25, 29 or 31 digits not %d" % len(value)
                )
    ...
    def binary(self):
        ...
        if not value:
            ...
            try:
                ...
                raise ValueError(
                    "Problem converting %s, routing code must be 0, 5, 9 or 11 digits" % routing
                )
            ...
            try:
                ...
                raise ValueError(
                    "Problem converting %s, barcode identifier must be 2 digits" % svalue
                )
            ...
            for name, nd in (
                ...
                try:
                    ...
                    raise ValueError(
                        "Problem converting %s, %s must be %d digits" % (svalue, name, nd)
                    )
            self._bvalue = value
        return value
