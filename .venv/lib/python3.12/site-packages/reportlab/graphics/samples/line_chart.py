...
class LineChart(_DrawingEditorMixin, Drawing):
    def __init__(self, width=200, height=150, *args, **kw):
        ...
        self._add(
            self, Label(), name="Title", validate=None, desc="The title at the top of the chart"
        )
        ...
        self._add(
            self, Legend(), name="Legend", validate=None, desc="The legend or key for the chart"
        )
        ...
        self._add(
            self, Label(), name="XLabel", validate=None, desc="The label on the horizontal axis"
        )
        ...
        self._add(
            self, Label(), name="YLabel", validate=None, desc="The label on the vertical axis"
        )
