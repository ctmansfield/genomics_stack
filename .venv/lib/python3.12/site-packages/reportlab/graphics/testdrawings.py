...
def getDrawing2():
    ...
    D.add(
        PolyLine([120, 10, 130, 20, 140, 10, 150, 20, 160, 10, 170, 20, 180, 10, 190, 20, 200, 10])
    )
    ...
    D.add(
        Rect(120, 150, 60, 30, strokeWidth=10, strokeColor=colors.red, fillColor=colors.yellow)
    )  # square corners
