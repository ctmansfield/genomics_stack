...
def getDrawing03():
    ...
    for size in range(12, 36, 4):
        D.add(
            String(10 + size * 2, 10 + size * 2, "Hello World", fontName=_FONTS[0], fontSize=size)
        )
...
def getDrawing06():
    ...
    D.add(
        PolyLine(
            [120, 10, 130, 20, 140, 10, 150, 20, 160, 10, 170, 20, 180, 10, 190, 20, 200, 10],
            fillColor=green,
        )
    )
    ...
    D.add(
        Rect(120, 150, 60, 30, strokeWidth=10, strokeColor=colors.yellow, fillColor=green)
    )  # square corners
