...
class Label(Widget):
    ...
    _attrMap = AttrMap(
        ...
        angle=AttrMapValue(
            isNumber, desc="angle of label: default (0), 90 is vertical, 180 is upside down, etc"
        ),
        ...
        boxTarget=AttrMapValue(
            OneOf("normal", "anti", "lo", "hi"), desc="one of ('normal','anti','lo','hi')"
        ),
    ...
    def computeSize(self):
        ...
        if not ddfKlass:
            ...
            if not self.width:
                ...
                if self._lines:
                    self._lineWidths = [
                        stringWidth(line, self.fontName, self.fontSize) for line in self._lines
                    ]
