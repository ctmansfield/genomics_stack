...
class DotBox(Widget):
    ...
    _attrMap = AttrMap(
        xlabels=AttrMapValue(
            isNoneOrListOfNoneOrStrings, desc="List of text labels for boxes on left hand side"
        ),
        ylabels=AttrMapValue(
            isNoneOrListOfNoneOrStrings, desc="Text label for second box on left hand side"
        ),
        ...
        labelOffset=AttrMapValue(isNumber, desc="Space between label text and grid edge"),
        ...
        dotDiameter=AttrMapValue(isNumber, desc="Diameter of the circle used for the 'dot'"),
