...
from reportlab.graphics.shapes import Group, Drawing, Line, Rect, Polygon, PolyLine, STATE_DEFAULTS
    ...
    def draw(self):
        ...
        for i in range(n):
            ...
            if text:
                S.append(
                    _setupLabel(
                        self.labelClass("spoke"), text, si.labelRadius, cx, cy, angle, car, sar, sli
                    )
                )
            angle += angleBetween
