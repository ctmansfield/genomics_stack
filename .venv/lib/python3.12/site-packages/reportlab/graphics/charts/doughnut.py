...
class Doughnut(AbstractPieChart):
    _attrMap = AttrMap(
        ...
        height=AttrMapValue(
            isNumber, desc="height of doughnut bounding box.  Need not be same as height."
        ),
        data=AttrMapValue(
    ...
    def makeSectors(self):
        ...
        if multi:
            ...
            for sn, series in enumerate(normData):
                for i, angle in enumerate(series):
                    ...
                    if len(series) > 1:
                        ...
                        theSector = Wedge(
                            cx, cy, xr, a1, a2, yradius=yr, radius1=xr1, yradius1=yr1, annular=True
                        )
            ...
            for i, angle in enumerate(normData):
                ...
                if n > 1:
                    theSector = Wedge(
                        cx, cy, xradius, a1, a2, yradius=yradius, radius1=xir, yradius1=yir
                    )
                elif n == 1:
                    theSector = Wedge(
                        cx,
...
def sample1():
    ...
    s1 = Wedge(
        centerx=200, centery=200, radius=150, startangledegrees=0, endangledegrees=120, radius1=100
    )
