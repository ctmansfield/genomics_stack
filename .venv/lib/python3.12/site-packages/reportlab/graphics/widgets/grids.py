...
class Grid(Widget):
    ...
    _attrMap = AttrMap(
        ...
        useLines=AttrMapValue(OneOf((0, 1)), desc="Determines if stripes are drawn with lines."),
        useRects=AttrMapValue(
            OneOf((0, 1)), desc="Determines if stripes are drawn with solid rectangles."
        ),
        delta=AttrMapValue(isNumber, desc="Determines the width/height of the stripes."),
        delta0=AttrMapValue(isNumber, desc="Determines the stripes initial width/height offset."),
        deltaSteps=AttrMapValue(isListOfNumbers, desc="List of deltas to be used cyclically."),
        stripeColors=AttrMapValue(
            isListOfColors, desc="Colors applied cyclically in the right or upper direction."
        ),
        fillColor=AttrMapValue(isColorOrNone, desc="Background color for entire rectangle."),
