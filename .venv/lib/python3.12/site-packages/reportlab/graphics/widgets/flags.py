...
class Star(_Symbol):
    ...
    def draw(self):
        ...
        # star specific bits
        star = Polygon(
            P, fillColor=self.fillColor, strokeColor=self.strokeColor, strokeWidth=s / 50
        )
        g.rotate(self.angle)
...
class Flag(_Symbol):
    ...
    def _Flag_None(self):
        ...
        g = Group()
        g.add(
            Rect(0, 0, s * 2, s, fillColor=colors.purple, strokeColor=colors.black, strokeWidth=0)
        )
        return g
    ...
    def _Flag_UK(self):
        ...
        g.add(
            Polygon(
                [0, 0, s * 0.225, 0, w, s * (1 - 0.1125), w, s, w - s * 0.225, s, 0, s * 0.1125],
        ...
        g.add(
            Polygon(
                [0, s * (1 - 0.1125), 0, s, s * 0.225, s, w, s * 0.1125, w, 0, w - s * 0.225, 0],
                fillColor=colors.mintcream,
                strokeColor=None,
                strokeWidth=0,
            )
    ...
    def _Flag_USA(self):
        ...
        box = Rect(
            0, 0, s * 2, s, fillColor=colors.mintcream, strokeColor=colors.black, strokeWidth=0
        )
        g.add(box)
    ...
    def _Flag_Finland(self):
        ...
        box = Rect(
            0, 0, s * 2, s, fillColor=colors.ghostwhite, strokeColor=colors.black, strokeWidth=0
        )
        g.add(box)
    ...
    def _Flag_Ireland(self):
        ...
        box = Rect(
            0, 0, s * 2, s, fillColor=colors.forestgreen, strokeColor=colors.black, strokeWidth=0
        )
        g.add(box)
    ...
    def _Flag_Norway(self):
        ...
        box = Rect(
            0, 0, self._width, s, fillColor=colors.red, strokeColor=colors.black, strokeWidth=0
        )
        g.add(box)
    ...
    def _Flag_CzechRepublic(self):
        ...
        redbox = Rect(
            0, 0, width=s * 2, height=s / 2.0, fillColor=colors.red, strokeColor=None, strokeWidth=0
        )
        g.add(redbox)
    ...
    def _Flag_Palestine(self):
        ...
        g = Group()
        box = Rect(
            0, s / 3.0, s * 2, s / 3.0, fillColor=colors.mintcream, strokeColor=None, strokeWidth=0
        )
        g.add(box)
