...
class Marker(Widget):
    ...
    def _Cross(self):
        ...
        return self._doPolygon(
            (-s, -h, -s, -s, -h, -s, -h, s, -s, s, -s, h, s, h, s, s, h, s, h, -s, s, -s, s, -h)
        )
    ...
    def _StarSix(self):
        ...
        g = c / 2
        return self._doPolygon(
            (0, r, -z, s, -c, s, -s, 0, -c, -s, -z, -s, 0, -r, z, -s, c, -s, s, 0, c, s, z, s)
        )
    ...
    def _doPolygon(self, P):
        ...
        return Polygon(
            P, strokeWidth=self.strokeWidth, strokeColor=self.strokeColor, fillColor=self.fillColor
        )
