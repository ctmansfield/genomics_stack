...
allowTableBoundsErrors = (
    1  # set to 0 to die on too large elements in tables in debug (recommend 1 for production use)
)
shapeChecking = 1
...
invariant = (
    0  # produces repeatable,identical PDFs with same timestamp info (for regression testing)
)
...
trustedSchemes = ["file", "rml", "data", "https", "http", "ftp"]  # these url schemes are trusted
